...
@section('content')
    ...
    <body>
        ...
        <div class="flex justify-center items-center h-full">
            <form class="w-full max-w-lg" method="POST" action="{{ route('StoreTransaction') }}">
                @csrf
                ...
                <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full px-3">
                        ...
                        <select name="cust_id" data-te-select-init id="nameid"
                            ...
                            <option value="" hidden selected aria-placeholder="">Select customer name</option>
                            @foreach ($cust as $cus)
                ...
                <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full px-3">
                        ...
                        <select name="book_id" data-te-select-init id="nameid2"
                            class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500">
                            <option value="" hidden selected>Select book name</option>
                ...
                <div class="flex flex-wrap -mx-3 mb-6">
                    ...
                    <div class="w-full md:w-1/3 px-3">
                        ...
                        <input
                            ...
                            type="number" placeholder="Days" name="days">
                    </div>
                    <div class="w-full md:w-1/3 px-3">
                        <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2"
                            for="grid-last-name">
                        ...
                        <input
                            class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                            type="date" placeholder="On returning day" name="return_at">
                    </div>
                </div>
